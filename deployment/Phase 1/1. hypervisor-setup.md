...
I use MobaXterm to connect to the virtual machine. To connect to the virtual machine, I need to use the IP address of the virtual machine and enable the SSH server on the virtual machine.
...
Change the 'attached to' from NAT to Bridge Adapter
